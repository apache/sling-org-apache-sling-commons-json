...
import org.apache.sling.commons.json.data.BrokenToString;
import org.apache.sling.commons.json.data.ExceptionalBean;
import org.apache.sling.commons.json.data.Fraction;
import org.apache.sling.commons.json.data.GenericBean;
import org.apache.sling.commons.json.data.GenericBeanInt;
import org.apache.sling.commons.json.data.MyBean;
import org.apache.sling.commons.json.data.MyBeanCustomName;
import org.apache.sling.commons.json.data.MyBeanCustomNameSubClass;
import org.apache.sling.commons.json.data.MyBigNumberBean;
import org.apache.sling.commons.json.data.MyEnum;
import org.apache.sling.commons.json.data.MyEnumField;
import org.apache.sling.commons.json.data.MyJsonString;
import org.apache.sling.commons.json.data.MyNumber;
import org.apache.sling.commons.json.data.MyNumberContainer;
import org.apache.sling.commons.json.data.MyPublicClass;
import org.apache.sling.commons.json.data.RecursiveBean;
import org.apache.sling.commons.json.data.RecursiveBeanEquals;
import org.apache.sling.commons.json.data.Singleton;
import org.apache.sling.commons.json.data.SingletonEnum;
import org.apache.sling.commons.json.data.WeirdList;
import org.apache.sling.commons.json.util.CDL;
import org.apache.sling.commons.json.util.ParserConfiguration;
import org.apache.sling.commons.json.util.Util;
...
public class JSONObjectTest {
        ...
        public void verifySimilar() {
                ...
                assertTrue("should eval to true",
                                new JSONObject().put("a", 1.1d).similar(new JSONObject("{\"a\":1.1}")));
        ...
        public void jsonObjectByMap() {
                ...
                assertTrue("expected \"stringKey\":\"hello world!\"",
                                "hello world!".equals(jsonObject.query("/stringKey")));
        ...
        public void jsonObjectByMapWithUnsupportedValues() {
                ...
                assertTrue("expected \"key2\":java.lang.Exception",
                                "java.lang.Exception".equals(jsonObject.query("/key2")));
                Util.checkJSONObjectMaps(jsonObject);
        }
        ...
        public void jsonObjectByBean1() {
                ...
                assertTrue("expected 0 mockitoInterceptor.serializationSupport items",
                                ((Map<?, ?>) (JsonPath.read(doc, "$.mockitoInterceptor.serializationSupport")))
                                                .size() == 0);
                Util.checkJSONObjectMaps(jsonObject);
        }
         ...
         * The test resource bundle is uncomplicated, but provides adequate test
         * coverage.
         */
        @Test
        public void jsonObjectByResourceBundle() {
                JSONObject jsonObject = new JSONObject("org.apache.sling.commons.json.data.StringsResourceBundle",
                                Locale.getDefault());
        ...
        public void jsonObjectAccumulate() {
                ...
                assertTrue("expected h\be\tllo w\u1234orld!",
                                "h\be\tllo w\u1234orld!".equals(jsonObject.query("/myArray/3")));
        ...
        public void stringToValueNumbersTest() {
                ...
                assertTrue("Integer.MAX_VALUE should still be an Integer!",
                                JSONObject.stringToValue(
                                                Integer.valueOf(Integer.MAX_VALUE).toString()) instanceof Integer);
                assertTrue("Large integers should be a Long!",
                                JSONObject.stringToValue(Long.valueOf(((long) Integer.MAX_VALUE) + 1)
                                                .toString()) instanceof Long);
        ...
        public void bigNumberOperations() {
                ...
                when(myBigNumberBean.getBigDecimal()).thenReturn(
                                new BigDecimal("123456789012345678901234567890.12345678901234567890123456789"));
        ...
        public void jsonObjectNamesToJsonAray() {
                ...
                assertTrue("expected to find trueKey",
                                ((List<?>) JsonPath.read(doc, "$[?(@=='trueKey')]")).size() == 1);
                assertTrue("expected to find falseKey",
                                ((List<?>) JsonPath.read(doc, "$[?(@=='falseKey')]")).size() == 1);
                assertTrue("expected to find stringKey",
                                ((List<?>) JsonPath.read(doc, "$[?(@=='stringKey')]")).size() == 1);
                Util.checkJSONObjectMaps(jsonObject);
                Util.checkJSONArrayMaps(jsonArray, jsonObject.getMapType());
        }
        ...
        public void jsonObjectIncrement() {
                 ...
                 */
                assertFalse("Document unexpected behaviour with explicit type-casting float as double!",
                                (double) 0.2f == 0.2d);
                ...
                inc.put("bug", Float.valueOf(3.1f)); // This will put in instance of Float into JSONObject, i.e. call
        ...
        public void jsonObjectParseControlCharacters() {
                for (int i = 0; i <= 0x001f; i++) {
                        ...
                        try {
                                ...
                                assertTrue("Expected " + charString + "(" + i
        ...
        public void jsonObjectOptDefault() {
                ...
                assertTrue("optJSONArray() should return default JSONArray",
                                "value".equals(jsonObject.optJSONArray("myKey", new JSONArray("[\"value\"]"))
                                                .getString(0)));
                assertTrue("optJSONObject() should return default JSONObject ",
                                jsonObject.optJSONObject("myKey", new JSONObject("{\"testKey\":\"testValue\"}"))
                                                .getString("testKey").equals("testValue"));
        ...
        public void jsonObjectOptStringConversion() {
                ...
                assertTrue("unexpected optIntegerObject value",
                                Integer.valueOf(123).equals(jo.optIntegerObject("int", 0)));
                ...
                assertTrue("unexpected optDoubleObject value",
                                Double.valueOf(123.0d).equals(jo.optDoubleObject("int", 0.0d)));
                assertTrue("unexpected optFloat value", jo.optFloat("int", 0.0f) == 123.0f);
                assertTrue("unexpected optFloatObject value",
                                Float.valueOf(123.0f).equals(jo.optFloatObject("int", 0.0f)));
        ...
        public void jsonObjectOptCoercion() {
                ...
                assertNotEquals(Integer.valueOf(
        ...
        public void jsonObjectNullOperations() {
                 ...
                 * javadoc):
                 * undefined value: primitive value used when a variable has not been assigned a
                 * value
                 ...
                 * no name.
                 * Because the null type has no name, it is impossible to declare a variable of
                 * the null
                 * type or to cast to the null type. The null reference is the only possible
                 * value of an
                 * expression of null type. The null reference can always be assigned or cast to
                 * any reference type.
        ...
        public void toMap() {
                ...
                assertTrue("key3 list val 1 list element 2 should be 2.1",
                                key3Val1List.get(1).equals(new BigDecimal("2.1")));
        ...
        private static final Number[] NON_FINITE_NUMBERS = { Double.POSITIVE_INFINITY, Double.NEGATIVE_INFINITY,
                        Double.NaN,
        ...
        public void issue713MapConstructorWithNonFiniteNumbers() {
                for (Number nonFinite : NON_FINITE_NUMBERS) {
                        ...
                        Assert.assertThrows(JSONException.class, () -> new JSONObject(map));
                }
        }
