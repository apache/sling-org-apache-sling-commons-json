...
public class JSONPointerTest {
    ...
    static {
        ...
        InputStream resourceAsStream = JSONPointerTest.class.getClassLoader()
                .getResourceAsStream("jsonpointer-testdoc.json");
        if (resourceAsStream == null) {
            throw new ExceptionInInitializerError(
                    "Unable to locate test file. Please check your development environment configuration");
        }
     ...
     * --> it's the string representation of "\\", so when query'ing via the
     * JSONPointer
