...
public class JSONMLTest {
    ...
    public void emptyJSONXMLException() {
        ...
        try {
            ...
            assertTrue("Expecting an exception message",
                    "JSONArray[0] not found.".equals(e.getMessage()));
        }
    }
    ...
    public void spaceInTagException() {
        ...
        try {
            ...
            assertTrue("Expecting an exception message",
                    "'addr esses' contains a space character.".equals(e.getMessage()));
        }
    }
    ...
    public void noCloseEndTagException() {
        ...
        try {
            ...
            assertTrue("Expecting an exception message",
                    "Expected a closing name instead of '>'.".equals(e.getMessage()));
        }
    }
    ...
    // 1. Our XML parser does not handle generic HTML entities, only valid XML
    // entities. Hence &nbsp;
    // or other HTML specific entities would fail on reversability
    // 2. Our JSON implementation for storing the XML attributes uses the standard
    // unordered map.
    // This means that <tag attr1="v1" attr2="v2" /> can not be reversed reliably.
    //
    // /**
    // * Test texts taken from jsonml.org. Currently our implementation FAILS this
    // conversion but shouldn't.
    // * Technically JsonML should be able to transform any valid xhtml document,
    // but ours only supports
    // * standard XML entities, not HTML entities.
    // */
    // @Test
    // public void testAttributeConversionReversabilityHTML() {
    // final String originalXml = "<table class=\"MyTable\"
    // style=\"background-color:yellow\"><tr><td class=\"MyTD\" style=\"border:1px
    // solid black\">#5D28D1</td><td class=\"MyTD\"
    // style=\"background-color:red\">Example text here</td></tr><tr><td
    // class=\"MyTD\" style=\"border:1px solid black\">#AF44EF</td><td
    // class=\"MyTD\" style=\"background-color:green\">127310656</td></tr><tr><td
    // class=\"MyTD\" style=\"border:1px solid black\">#AAD034</td><td
    // class=\"MyTD\" style=\"background-color:blue\">&nbsp;<span
    // style=\"background-color:maroon\">&copy;</span>&nbsp;</td></tr></table>";
    // final String expectedJsonString = "[\"table\",{\"class\" :
    // \"MyTable\",\"style\" :
    // \"background-color:yellow\"},[\"tr\",[\"td\",{\"class\" : \"MyTD\",\"style\"
    // : \"border:1px solid black\"},\"#550758\"],[\"td\",{\"class\" :
    // \"MyTD\",\"style\" : \"background-color:red\"},\"Example text
    // here\"]],[\"tr\",[\"td\",{\"class\" : \"MyTD\",\"style\" : \"border:1px solid
    // black\"},\"#993101\"],[\"td\",{\"class\" : \"MyTD\",\"style\" :
    // \"background-color:green\"},\"127624015\"]],[\"tr\",[\"td\",{\"class\" :
    // \"MyTD\",\"style\" : \"border:1px solid
    // black\"},\"#E33D87\"],[\"td\",{\"class\" : \"MyTD\",\"style\" :
    // \"background-color:blue\"},\"\u00A0\",[\"span\",{ \"style\" :
    ...
    // class=\"MyTD\" style=\"border:1px solid black\">#AAD034</td><td
    // class=\"MyTD\" style=\"background-color:blue\">&amp;<span
    // style=\"background-color:maroon\">&gt;</span>&lt;</td></tr></table>";
    // final String expectedJsonString = "[\"table\",{\"class\" :
    // \"MyTable\",\"style\" :
    // \"background-color:yellow\"},[\"tr\",[\"td\",{\"class\" : \"MyTD\",\"style\"
    // : \"border:1px solid black\"},\"#550758\"],[\"td\",{\"class\" :
    ...
    // // currently not equal because the hashing of the attribute objects makes the
    // attribute
    ...
    public void testIssue484InfinteLoop1() {
        try {
            JSONML.toJSONObject(
                    "??*^M??|?CglR^F??`??>?w??PIlr^E??D^X^]?$?-^R?o??O?*??{OD?^FY??`2a????NM?b^Tq?:O?>S$^K?J?^FB.gUK?m^H??zE??^??!v]?^A???^[^A??^U?c??????h???s???g^Z???`?q^Dbi??:^QZl?)?}1^??k?0??:$V?$?Ovs(}J??^V????2;^QgQ?^_^A?^D?^U?Tg?K?`?h%c?hmGA?<!C*^P^Y?^X9?~?t?)??,z^XA???S}?Q??.q?j????]");
    ...
    public void testToJSONArrayMaxNestingDepthOf42IsRespected() {
        ...
        try {
            JSONML.toJSONArray(wayTooLongMalformedXML,
                    JSONMLParserConfiguration.ORIGINAL.withMaxNestingDepth(maxNestingDepth));
    ...
    public void testToJSONArrayMaxNestingDepthIsRespectedWithValidXML() {
        ...
        try {
            JSONML.toJSONArray(perfectlyFineXML,
                    JSONMLParserConfiguration.ORIGINAL.withMaxNestingDepth(maxNestingDepth));
        ...
        try {
            ...
            assertTrue("Wrong throwable thrown: not expecting message <" + e.getMessage() + ">",
                    e.getMessage().startsWith(
                            "Maximum nesting depth of " + JSONMLParserConfiguration.DEFAULT_MAXIMUM_NESTING_DEPTH));
        }
    }
    ...
    public void testToJSONObjectMaxNestingDepthOf42IsRespected() {
        ...
        try {
            JSONML.toJSONObject(wayTooLongMalformedXML,
                    JSONMLParserConfiguration.ORIGINAL.withMaxNestingDepth(maxNestingDepth));
    ...
    public void testToJSONObjectMaxNestingDepthIsRespectedWithValidXML() {
        ...
        try {
            JSONML.toJSONObject(perfectlyFineXML,
                    JSONMLParserConfiguration.ORIGINAL.withMaxNestingDepth(maxNestingDepth));
